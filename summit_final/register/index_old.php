...
<html dir="ltr" lang="zxx">
 ...
 <section class="main-container">
    ...
    <section class="main-container" id="acco">
      ...
      <p> Accommodation charges are Rs. 2100 per head for 3 nights 26,27,28 Jan.<br>
      <b>Note : </b>Accommodation is only for students.<br>
       Register below for accomodation  </p>
      <!-- <form action="action_page.php" method="POST"> -->
        
        <br>
        <p style="display: block;margin: auto;" >
          <a href="https://www.townscript.com/e/accommodation-esummit-042133"><button style="color: rgb(230, 231, 234);border-color: rgb(230, 231, 234);" class="btn btn-1 btn-1e serviceswaala" style="z-index: 200;">Register
