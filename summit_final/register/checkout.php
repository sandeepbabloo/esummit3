  ...
  <head>
    ...
    //      alert(data);
      ...
      $.ajax({
        ...
        success: function(result){
          if(result=="success"){
          alert("You have entered a correct cr_id. You have got 50 Rs discount! CR will get 2,000 points after payment is successful");
          $("#crid").css("display", "none");
          $("#validate_crid").css("display", "none");
           $("#cr_text").css("display", "none");
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="main col-8" style="background: url(../images/patterns/pattern_light.png);">
              ...
              <?php } ?>
               <?php if($type=="stud"){ ?>
             <p id="cr_text" class="light-black">Please type in the CR ID if you have been referred by a CR, to get a discount of INR 50</p>
              <input id="crid" type="text" name="crid" style="margin-left: 18px;" placeholder="cr id">
                  ...
                  <div class="row">
                    ...
                    <div class="col-xl-8 ml-xl-auto">
                      ...
                      <div style="display: none;">
                        ...
                        <input type="text" name="redirect_url" value="https://www.ecell.in/esummit_18/register/ccavResponseHandler.php">
                        <input type="text" name="currency" value="INR">
                        <input type="text" name="cancel_url" value="https://www.ecell.in/esummit_18/register/ccavResponseHandler.php"/>
